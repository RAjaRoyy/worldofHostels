...
const Cprabhu = () => {
    ...
    const handledClose = () => setNewshow(false);
    const handledShow = () => setNewshow(true);
    return (
        <section>
            <div style={{ marginLeft: "100px" }}>
                <img src={bedroom} style={{ height: '500px', width: '90%', borderRadius: '25px', marginRight: "100px" }}></img>

                {/* <Carousel style={{ width: "1300px", borderRadius: '10px' }}>
            <Carousel.Item interval={1000} style={{ borderRadius: '10px' }} >
                <img src={bedroom} text="First slide" alt='' style={{ height: '520px', width: "1300px", borderRadius: '10px' }} />
            </Carousel.Item>
            <Carousel.Item interval={1000}>
                <img src={bedroom2} text="Second slide" alt='' style={{ height: '520px', width: "1300px", borderRadius: '10px' }} />
            </Carousel.Item >
            <Carousel.Item interval={1000}>
                <img src={bedroom3} text="Third slide" alt='' style={{ height: '520px', width: "1300px", borderRadius: '10px' }} />
            </Carousel.Item>
            <Carousel.Item interval={1000}>
                <img src={bedroom4} text="Third slide" alt='' style={{ height: '520px', width: "1300px", borderRadius: '10px' }} />
            </Carousel.Item>
        </Carousel> */}
            </div>

            <div>
                <Typography variant='h2' style={{ color: "white", textAlign: "center", fontFamily: "-moz-initial" }}></Typography>
            </div>
            ...
            <div style={{ padding: "80px", marginBottom: "50px" }}>
                <Typography variant='h4' style={{ fontFamily: "Open Sans", marginTop: "10px", fontWeight: '500', fontSize: '30px' }} >Prabhus place in Chennai</Typography >
                <div style={{ display: 'flex' }}>
                    <LocationOnIcon style={{ fontSize: "30px" }} />
                    <Typography variant='h6' style={{ fontFamily: 'Roboto', fontSize: '18px', fontWeight: '400' }}> Chennai, Kalipathur, Tamil Nadu, India</Typography>
                </div>
                ...
                >
                    <Tab eventKey="about" title={<span><InfoIcon />  About</span>}>
                        <div>
                            <p style={{ fontFamily: "Roboto", fontSize: "18px",width:'950' }}>{resultStr}</p>
                    ...
                    <Tab eventKey="location" title={<span><FmdGoodIcon />  Location</span>}>
                        ...
                        <Typography variant='h4' style={{ fontFamily: 'Open Sans', fontSize: '18px' }}>Ramaniyam Suites and Siruseri 2 bed apartment</Typography>
                        <iframe width="50%" height="400" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" src="https://maps.google.com/maps?width=100%25&amp;height=600&amp;hl=en&amp;q=No.37,%20Kazhipattur%20Village,%20Siruseri,,%20Chennai,%20Tamil%20Nadu+(World%20of%20Hostels)&amp;t=&amp;z=14&amp;ie=UTF8&amp;iwloc=B&amp;output=embed"><a href="https://www.gps.ie/">gps devices</a>
                        </iframe>
                    </Tab>
                    {/* <Tab eventKey="review" title="Review"> */}
                    <Tab eventKey="review" title={<span><RateReviewIcon />  Review</span>}>

                        <Typography variant="h6" style={{ backgroundColor: "tomato", margin: "20px", fontFamily: 'Roboto',width:'50%' }} >⭐ 100% genine Review from real hostel travelers like you!</Typography>
                        <div style={{ display: "flex", gap: "30px", margin: "30px" }}>
                            <div>
                                <h1 style={{ backgroundColor: "tomato", color: "white" }}>6.5</h1>
                            </div>
                            <div>
                                <div>
                                    <h5 style={{ fontFamily: 'Roboto' }}>Good</h5>
                                    <h6 style={{ fontFamily: 'Roboto' }}>30 Total Reviews</h6>
                                </div>
                            </div>
                        </div>
                        <div style={{ display: "flex", gap: "30px", margin: "30px" }}>
                        ...
                        <div
                            ...
                            <div>
                                <Carousel style={{ width: '15rem', borderRadius: '10px' }}>
                                    ...
                                    <Carousel.Item interval={500}>
                                        <img src={bedroom3} text="Second slide" alt='' style={{ height: '250px', borderRadius: '10px' }} />
                                    </Carousel.Item>
                                    <Carousel.Item interval={500}>
                                        <img src={bedroom4} text="Second slide" alt='' style={{ height: '250px', borderRadius: '10px' }} />
                                    </Carousel.Item>
                                    <Carousel.Item interval={500}>
                                        <img src={chennaipic} text="Second slide" alt='' style={{ height: '250px', borderRadius: '10px' }} />
                                    </Carousel.Item>

                                </Carousel>
                            </div>
                            <div style={{ marginLeft: "45px" }}>
                                <Typography variant='h4' style={{ fontFamily: 'Open Sans', fontSize: '18px', fontWeight: '500' }}> Ramaniyam Suites and Siruseri 2 bed apartment </Typography>
                                <div style={{ display: "flex" }}>
                                    <div className='ot-groupicons' style={{ gap: "10px" }} >

                                        <div>
                                            <p style={{ fontSize: "14px", marginTop: "10px", fontFamily: "Roboto" }}>Fully furnished 2 bed 2 bath apartment with cooking amenities including a microwave oven, Fridge, utensils, a washer and a space to dry your clothes in the balcony. </p>
                                        </div>
                ...
                <div style={{ width: "350px", marginLeft: "20px" }}>
                    ...
                    <Card >
                        <div style={{ padding: "20px" }}>
                            <Typography variant='h6' style={{ fontFamily: 'Roboto' }}>My Selection</Typography>
                            ...
                            <div style={{ display: "flex", gap: "70px", marginTop: "20px" }}>
                                <Typography style={{ fontFamily: 'Roboto', fontSize: '18px' }}>Payable Amount 10%</Typography >
                                <h6>₹286</h6>
                            </div>
                            <div style={{ display: "flex", gap: "150px", marginTop: "20px" }}>
                                <Typography style={{ fontFamily: 'Roboto', fontSize: '18px' }}>Total Amount</Typography >
                                <h6>₹0</h6>
